...
export default function ConferenceDetails() {
  ...
  const importantDates = [
    { label: 'Paper Submission Deadline', date: 'January 31, 2026', icon: Calendar },
    { label: 'Notification of Acceptance', date: 'March 15, 2026', icon: Calendar },
    { label: 'Final Program Announcement', date: 'April 15, 2026', icon: Calendar },
    { label: 'Registration Deadline', date: 'May 29, 2026', icon: Calendar },
    { label: 'Conference Date', date: 'June 13, 2026', icon: Calendar, highlight: true },
  ];

  // Research Topics
  const researchTopics = [
    {
      name: 'AI, Machine Learning, and Big Data in Accounting',
      description: 'Research on artificial intelligence, machine learning algorithms, and big data analytics applications in accounting'
    },
    {
      name: 'Financial Accounting',
      description: 'Research on financial reporting, disclosure, earnings quality, and capital markets'
    },
    {
      name: 'Managerial Accounting',
      description: 'Research on cost accounting, budgeting, performance measurement, and management control systems'
    },
    {
      name: 'Auditing',
      description: 'Research on audit quality, audit technology, internal controls, and assurance services'
    },
    {
      name: 'Taxation',
      description: 'Research on tax planning, tax policy, corporate taxation, and international tax'
    },
    {
      name: 'ESG and Sustainability Reporting',
      description: 'Research on environmental, social, and governance reporting and performance'
    },
    {
      name: 'Accounting Information Systems',
      description: 'Research on information systems design, implementation, and security in accounting contexts'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              2026 2nd Hanyang Accounting Research Symposium
            </h1>
            <p className="text-xl md:text-2xl mb-6">June 13, 2026 (Saturday)</p>
            <div className="flex items-center justify-center gap-2 text-lg mb-8">
              <MapPin className="h-5 w-5" />
              <span>Hanyang University Business School, Seoul, Korea</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              Department of Accounting at Hanyang University Business School invites submissions for the 2026 2nd Hanyang
              Accounting Research Symposium (HARS) to be held on June 13, 2026, in Seoul, Korea.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              The symposium provides a premier platform for rigorous academic exchange among leading accounting scholars from
              around the world. Selected papers will be presented in concurrent sessions with designated discussants, allowing for
              in-depth scholarly dialogue. Exceptional papers may be designated as Featured Papers and presented in special
              morning sessions.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed">
              The symposium will recognize outstanding research through <strong>Best Paper and Outstanding Paper Awards</strong> with
              cash prizes.
            </p>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-amber-50 to-yellow-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mt-6 text-lg">
            Award recipients will be announced during the Closing Remarks on June 13, 2026.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Hanyang University Business School</h3>
      ...
      <section className="bg-gradient-to-r from-primary-600 to-accent-600 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl mb-8">
            We look forward to receiving your submissions and welcoming you to Seoul in June 2026!
          </p>
          <Link to="/submit-paper">
